...
export const webSearchTool = new DynamicTool({
  name: 'web_search',
  description:
    'Use this tool for up-to-date external information, such as news, recent events, current pricing, or anything likely to have changed after the model training data.',
