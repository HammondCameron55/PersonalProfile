...
export const knowledgeBaseSchema = z.object({
  query: z
    ...
    .describe(
      'Query over Cameron’s curated knowledge base (resume, selected docs, portfolio materials).'
    )
});
...
export const knowledgeBaseTool = new DynamicTool({
  name: 'knowledge_base',
  description:
    'Use this tool to look up factual information about Cameron, his experience, and his documented projects in the curated knowledge base. Prefer this over web_search for questions about Cameron specifically.',
